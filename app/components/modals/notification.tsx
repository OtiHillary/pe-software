...
export default function Notification( { visibility, setVisibility } ){
    return (
        <>
            <div className={ ` ${ visibility? 'visible': 'invisible' } logout rounded-sm shadow-lg bg-white w-96 h-108 p-2 pt-1 z-30 flex flex-col absolute top-24 right-8` }>
                <div className="flex justify-between m-2 mx-4 ">
                    <p>Notifications</p> 
                    <CloseCircle className='hover:text-red-400' onClick={ () => setVisibility() }/> 
                </div>
