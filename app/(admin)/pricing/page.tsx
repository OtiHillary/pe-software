export default function Home() {
   return(
      <main className="w-full bg-white m-4 flex flex-col">
         <div className= "m-2">
         ...
         <div className="m-2 flex justify-between">
            <div className="price-card bg-white h-96 w-72 border rounded-3xl flex flex-col justify-between p-4">
            ...
            <div className="price-card bg-pes h-96 w-72 border rounded-3xl flex flex-col justify-between p-4 text-white">
               <div className="flex flex-col">
                  <div className="bg-white text-pes opacity-40 rounded-xl py-1 px-2 text-center mb-2">Current plan</div>
