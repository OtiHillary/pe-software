...
const Dashboard: React.FC<DashboardProps> = ({ performance }) => {
   ...
   const good: performance_type[] = []
   const bad: performance_type[] = []

   const perform = { goodPerformance: good, badPerformance: bad}
         ...
         <div className="(right_panel)-- w-1/2">
            <div className="w-full shadow-md shadow-gray-100 p-4 bg-white">
               ...
               <div className='flex flex-col p-4'>
                  {
                     perform.goodPerformance.map((i, key) => {
                     return(
                        <>
                           <div key={ key } className='  goal-metrics w-full flex justify-between my-4 text-sm'>
                           <p>{ i.name }</p>
               ...
               <div className="flex flex-col p-4">
                  {
                     perform.badPerformance.map((i, key: number) => {
                     return(
                        <>
                           <div key={ key } className='goal-metrics w-full flex justify-between my-4 text-sm'>
                           <p>{ i.name }</p>
