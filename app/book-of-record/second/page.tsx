...
// Fetch data from backend
    useEffect(() => {
        const fetchData = async () => {
            ...
            const res = await fetch(`/api/second-book-api/appraisal?page=${currentPage}&limit=${ITEMS_PER_PAGE}`);
        ...
        <div className="bg-gradient-to-r from-pes to-pes text-white p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold">2nd Book of Record(Appraisal)</h2>
            </div>
